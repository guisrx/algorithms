...
class Main {
    ...
    static class LCDisplayBuilder {
        ...
        // can cache the responses here (dynamic programming)
        ...
        public void print(final char[][] display) {

            for (int line = 0; line < display.length; line++) {
                final String row = new String(display[line], 0, display[line].length -1);
